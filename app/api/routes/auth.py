...
@router.post(
    "/permission/select", dependencies=[Depends(check_scopes("permission:select"))]
)
...
@router.post(
    "/permission/create", dependencies=[Depends(check_scopes("permission:create"))]
)
...
@router.post(
    "/permission/update", dependencies=[Depends(check_scopes("permission:update"))]
)
...
@router.post(
    "/permission/delete", dependencies=[Depends(check_scopes("permission:delete"))]
)
